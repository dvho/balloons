...
(() => {
    ...
    for (i = 1; i < 53; i++) {
        ...
        addBalloonEventListers = (e) => {
                ...
                explosionBigSwitcher = (explosionBigSwitcher + 1) % 2; //Alternate between 0 and 1 to switch between two identical animations.
...
(chance = () => {
    specialChance = Math.ceil(Math.random() * 18);
    setTimeout(chance, 6200);
})();
